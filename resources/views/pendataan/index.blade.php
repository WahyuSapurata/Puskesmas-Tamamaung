                            ...
                            <tbody>
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            {{ \Carbon\Carbon::parse($item->tgl_lahir_bayi)->diffInMonths(\Carbon\Carbon::parse($item->created_at)) }}
                                            Bulan
                                        </td>
                                        ...
                                        <td>{{ $item->jkel }}</td>
                                        <td>
                                            <a href="{{ route('pendataan.edit', $item->id) }}"
                                                class="btn btn-sm btn-primary btn-icon">
                                                <i data-feather="edit"></i>
                                            </a>
                                            <form action="{{ route('pendataan.destroy', $item->id) }}"
